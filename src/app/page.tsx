...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        ...
        {
          imageSrc: "http://img.b2bpic.net/free-photo/young-coworkers-discussing-work-subject_23-2147668781.jpg",
          imageAlt: "Graphic Design Strategy Concept 3",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/still-life-graphic-design-office_23-2151345458.jpg",
          imageAlt: "Graphic Design Strategy Concept 4",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/minimalist-desk-setup-with-lamp-notebook-stationery_23-2151968869.jpg",
          imageAlt: "Graphic Design Strategy Concept 5",
        },
        {
          ...
          imageAlt: "Graphic Design Strategy Concept 6",
        },
      ]}
    />
  </div>
      ...
      features={[
        {
          ...
          description: "High-impact visual designs for print and digital media.",
          items: [
            {
              icon: PenTool,
              text: "Brand Identity",
          ...
          reverse: false,
          imageSrc: "http://img.b2bpic.net/free-photo/female-executive-reading-sticky-notes_1170-1928.jpg",
          imageAlt: "Female executive reading sticky notes",
        },
        {
          title: "Content Strategy",
          description: "Persuasive copywriting and content marketing solutions.",
          items: [
            {
              icon: Type,
              text: "Copywriting",
        ...
        },
        {
          ...
          description: "Visionary guidance to unify your brand aesthetics.",
          items: [
            {
              icon: Camera,
              text: "Art Direction",
      ...
      products={[
        {
          ...
          imageAlt: "graphic design poster concept 1",
        },
        {
          id: "p2",
          name: "Digital Marketing Campaign",
          price: "Featured",
          imageSrc: "http://img.b2bpic.net/free-psd/design-event-print-template_23-2149015965.jpg",
          imageAlt: "graphic design poster concept 2",
        },
        {
          id: "p3",
          name: "Print Material Suite",
          price: "Featured",
          imageSrc: "http://img.b2bpic.net/free-photo/creative-postcard-set-blue-wall_53876-26209.jpg",
          imageAlt: "graphic design poster concept 3",
        },
        {
          id: "p4",
          name: "UI/UX Concept App",
          price: "Featured",
          imageSrc: "http://img.b2bpic.net/free-photo/mirrors-blue-table-isolated-orange_171337-13162.jpg",
          imageAlt: "graphic design poster concept 4",
        },
        {
          id: "p5",
          name: "Strategic Brand Launch",
          price: "Featured",
          imageSrc: "http://img.b2bpic.net/free-photo/improve-ideas-inspiration-creative-concept_53876-138650.jpg",
          imageAlt: "graphic design poster concept 5",
        },
        {
          id: "p6",
          name: "Creative Direction Project",
          price: "Featured",
          imageSrc: "http://img.b2bpic.net/free-photo/full-shot-woman-working-photography-studio_23-2150254651.jpg",
          imageAlt: "graphic design poster concept 6",
        },
      ]}
      ...
      testimonials={[
        {
          id: "1",
          title: "Exceptional",
          quote: "The creative direction provided was exactly what we needed to launch our brand.",
          name: "Sarah Miller",
          role: "CEO",
        ...
        },
        {
          id: "2",
          title: "Outstanding",
          quote: "Incredible communication and beautiful design work. Highly recommend.",
          name: "Mark Evans",
          role: "Marketing Lead",
        ...
        },
        {
          id: "3",
          title: "Strategic",
          quote: "Posters By Sid turned our vision into a cohesive reality.",
          name: "Emily Chen",
        ...
        },
        {
          id: "4",
          title: "Innovative",
          quote: "Truly transformed our digital presence with fresh designs.",
          name: "James Doe",
          role: "Product Owner",
        ...
        },
        {
          id: "5",
          title: "Professional",
          quote: "A seamless workflow and stunning final output every single time.",
          name: "Alice Wang",
          role: "Brand Manager",
      ...
      faqs={[
        {
          ...
          content: "We follow a holistic approach starting with strategy, moving into design execution, and finishing with brand alignment.",
        },
        {
          id: "f2",
          title: "How long does a project take?",
          content: "Timelines vary depending on project scope; we define specific project milestones and delivery dates upfront.",
        },
        {
          id: "f3",
          title: "Do you provide consultations?",
          content: "Yes, we encourage consultations to understand your marketing goals and creative vision.",
        },
      ]}
